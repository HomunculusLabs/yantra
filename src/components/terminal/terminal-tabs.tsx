...
export function TerminalTabs() {
  ...
  return (
    <div
      ref={containerRef}
      className="flex flex-col border-t border-border bg-card/70 backdrop-blur-sm"
    ...
    >
      ...
      {/* Tab bar */}
      <div className="flex items-center bg-muted/60 border-b border-border/60 px-1 shrink-0">
